...
public class UserMapper {
    ...
    public UserMinDto convertToMinDto(User user) {
    ...
    public List<UserMinDto> getConvertedUsersToMinDto(List<User> users) {
        return users.stream().map(this::convertToMinDto).toList();
    }
}
